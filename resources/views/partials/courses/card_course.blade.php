<div class="card card-01">
    <img class="card-img-top" src="{{ asset($course->pathAttachment()) }}" alt="{{ $course->name }}">
    <div class="card-body">
        ...
        <a href="{{ route('course.detail', $course->slug) }}" class="btn btn-course btn-block">{{ __('Más información') }}</a>
    </div>
</div>
